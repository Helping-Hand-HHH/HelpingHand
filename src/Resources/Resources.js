...
function Resources() {
  const cards = [
    ...
    <div className='block'>
      <div className='f-card'>
        <div className="f-section">
          <a target='_blank' href="https://www.nami.org/home">
            <h2>NAMI</h2>
    ...
    <div className='block'>
      <div className='f-card'>
        <div className="f-section">
          <a target='_blank' href="https://www.cdc.gov/mentalhealth/index.htm">
            <h2>CDC</h2>
    ...
    <div className='block'>
      <div className='f-card'>
        <div className="f-section">
          <a target='_blank' href="https://search.yahoo.com/local/s;_ylt=AwrO_03cNNFltwIL.WFXNyoA;_ylu=Y29sbwNncTEEcG9zAzEEdnRpZAMEc2VjA3Nj?type=E211US714G0&p=mental+health+clinics+near+me&fr=mcafee">
      ...
      <div className='f-card'>
        <div className="f-section">
          <a target='_blank' href="https://www.helpguide.org/articles/therapy-medication/support-groups.htm">
