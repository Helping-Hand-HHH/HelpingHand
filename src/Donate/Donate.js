  ...
  const cards = [
    <div className='block'>
      <div className='g-card'>
        ...
        <a target='_blank' rel="noreferrer" href="https://www.mhanational.org/donate-now">
    ...
    <div className='block'>
      <div className='g-card'>
        <div className="g-section">
        <a target='_blank' rel="noreferrer" href="https://supporting.afsp.org/?_gl=1*frnbi4*_ga*MTM3MzEzMDcwMS4xNzA4MjIwMjMy*_ga_44VZZG2H84*MTcwODIyMDIzMS4xLjEuMTcwODIyMDg4My42MC4wLjA.">
              <h2>AFSP</h2>
    ...
    <div className='block'>
      <div className='g-card'>
        <div className="g-section">
          <a target='_blank' rel="noreferrer" href="https://childmind.org/?form=maindonate">
    ...
    <div className='block'>
      <div className='g-card'>
        <div className="g-section">
          <a target='_blank' rel="noreferrer" href="https://www.nami.org/Home?campaign=509521">
            <h2>NAMI</h2>
